...
import websiteLoader from '../assets/websiteloader.json';
...
const WebsiteLoader = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#FAFBFD] dark:bg-[#02410A] flex items-center justify-center z-50">
      {/* Lottie Loader (commented out) */}
      {/* <div className="w-64 h-64">
        <Lottie
          animationData={websiteLoader}
          loop={true}
          autoplay={true}
        />
      </div> */}
