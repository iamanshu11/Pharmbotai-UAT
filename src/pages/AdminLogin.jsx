...
const STATIC_USERNAME = 'itsupport@pharmbotai.com';
...
export default function AdminLogin() {
  ...
  const handleAdminLogin = async () => {
    ...
    setIsLoading(true);
    setTimeout(() => {
      if (email === STATIC_USERNAME && password === STATIC_PASSWORD) {
  ...
  return (
    <div className={`min-h-screen flex flex-col bg-white dark:bg-[linear-gradient(to_right,_#042904_0%,_#265818_31%,_#71BF44_100%)] text-black dark:text-white`}>
      ...
      {popup.show && (
        <div
          className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 px-4 py-2 rounded-lg shadow-lg flex items-center gap-2 text-white ${
